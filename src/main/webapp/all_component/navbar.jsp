...
<nav class="navbar navbar-expand-lg navbar-dark bg-costum navbar-costum">
  <a class="navbar-brand" href="#"><i class="fa fa-bookmark-o" aria-hidden="true"></i><b> MyNotes</b></a>
